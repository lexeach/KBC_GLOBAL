...
const WriteAbleFun = () => {
  ...
  const [withrdrawlIncome, setwithrdrawlIncome] = useState(0);
  ...
  // const address = "0xFCd6459C02FaF599b690C218DF85e7f2aB98aF2d";
  ...
  useEffect(() => {
    ...
    let dat = (balanceIncome * 1e18) / Number(KBC_price);
    console.log("Data of KBC Price Showing here :", dat);

    setwithrdrawlIncome(dat);
  }, [balanceIncome]);
  useEffect(() => {
  ...
  const onFinishReg = async (values: RegistrationValues) => {
    try {
      // console.log("Value divide by 100", Number(kbcVal % 100));
